      ...
      <div className="min-h-screen bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 flex flex-col items-center justify-center p-6 text-white">
        <div className="w-full max-w-md text-center space-y-8 fade-in">
          ...
          <div className="space-y-4">
            <Button onClick={startQuiz} className="bg-white text-indigo-600 hover:bg-indigo-50 shadow-lg text-xl py-4">
              开始鉴定
            </Button>
      ...
      <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center p-6">
        <div className="w-full max-w-md bg-white rounded-3xl shadow-xl p-8 fade-in">
          ...
          <form onSubmit={handleProfileSubmit} className="space-y-6">
            ...
            <Button onClick={() => {}} disabled={!profile.nickname || !profile.gender} className="mt-8">
              生成报告
            </Button>
          </form>
        </div>
  ...
  if (stage === AppStage.RESULT) {
    return (
      <div className="min-h-screen bg-gradient-to-b from-purple-50 to-white p-6 flex flex-col items-center">
        <div className="w-full max-w-md bg-white rounded-[2rem] shadow-2xl overflow-hidden border border-purple-100 fade-in my-auto">
          
          {/* Header Card */}
          <div className="bg-gradient-to-r from-indigo-500 to-purple-600 p-8 text-center text-white relative overflow-hidden">
          ...
          <div className="p-8 text-center">
            ...
            <div className="space-y-3">
              <Button onClick={() => alert('假装分享成功！')} variant="primary" className="flex items-center justify-center gap-2 bg-gradient-to-r from-green-500 to-emerald-600 border-none">
                <Share2 className="w-5 h-5" />
                分享给好友
              </Button>
              <Button onClick={restart} variant="ghost" className="flex items-center justify-center gap-2">
